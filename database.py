...
cursor.execute("INSERT INTO FOOD (FOOD_NAME, FOOD_ID, CALORIES, CARBS, FATS, PROTEINS, FIBER, FOOD_GROUP) VALUES ('Spaghetti & veggie meatballs', 1086, 350, 45, 10, 15, 8, 'Vegan')")
cursor.execute("INSERT INTO FOOD (FOOD_NAME, FOOD_ID, CALORIES, CARBS, FATS, PROTEINS, FIBER, FOOD_GROUP) VALUES ('Shepherd's pie', 1087, 400, 30, 20, 20, 5, 'Balanced')")
cursor.execute("INSERT INTO FOOD (FOOD_NAME, FOOD_ID, CALORIES, CARBS, FATS, PROTEINS, FIBER, FOOD_GROUP) VALUES ('Veggie shepherd's pie', 1088, 350, 35, 15, 15, 8, 'Vegan')")
cursor.execute("INSERT INTO FOOD (FOOD_NAME, FOOD_ID, CALORIES, CARBS, FATS, PROTEINS, FIBER, FOOD_GROUP) VALUES ('Vegetable stir-fry w/ tofu and brown rice', 1089, 300, 40, 10, 15, 8, 'Balanced')")
